...
#Add a sky with an enviroment map.
env = viz.add(viz.ENVIRONMENT_MAP, 'skk.jpg')
dome = viz.add('sktdome.dlc')
dome.texture(env)
...
#Link the subview to the postition
